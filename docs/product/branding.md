...
- **Tab title area** — Screen titles on tab roots **do not** need a different background from the page. Avoid a **darker or lighter green header band**; use **one continuous emerald field** and the title as **typography only** (decision 0001).
